...
public class DOFavoriteButton: UIButton {
    ...
    @IBInspectable public var imageColorOff: UIColor! = UIColor(red: 177/255, green: 177/255, blue: 177/255, alpha: 1.0) {
        didSet {
            if (!selected) {
    ...
    private func createLayers(image image: UIImage!) {
        ...
        let imageFrame = CGRectMake(frame.size.width  / 4, frame.size.height / 2 - frame.size.height / 4, frame.size.width / 2, frame.size.height / 2)
