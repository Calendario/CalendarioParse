...
/*************************************************
 THIS CLASS IS REQUIRED FOR THE PROFILE VIEW
 CONTROLLER - PLEASE DO NOT DELETE IT.

 YOU CAN USE THIS CLASS TO ADD TH BADGE TO ANY
 UI OBJECT SUCH AS A UIBUTTON OR A UIIMAGEVIEW.
*************************************************/
